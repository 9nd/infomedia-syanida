	...
	*/
		...
		switch(count($arr)){
			case 1:	//tidak ada link  ex. #		
				...
				echo menu_parent_open('Dashboard','fe fe-airplay',site_url()."home",$active,false);	//membuat menu home dan menjadikan NON AKtif
				echo menu_parent_close();
			...
			case 2:	//hanya berisi folder & file controller 	ex. sys/pengaturan
				...
				echo menu_parent_open('Dashboard','fe fe-airplay',site_url()."home",false,false);	//membuat menu home dan menjadikan NON Aktif
				echo menu_parent_close();
