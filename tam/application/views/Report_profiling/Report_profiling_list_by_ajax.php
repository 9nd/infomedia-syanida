...
?>
	<div class='col-md-6 col-xl-6'>
		<div class="card">
			...
			<div class="card-header">
				<h3 class="card-title">Regular Periode <?php echo $_GET['start'] . " sd " . $_GET['end'] ?>
				</h3>
				<div class="card-options">
					<a href="#" class="card-options-collapse " data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
					<a href="#" class="card-options-fullscreen " data-toggle="card-fullscreen"><i class="fe fe-maximize"></i></a>
				...
				<div class='box-body table-responsive' id='box-table'>
					<small>
						<table class='table'>
							<thead>
								<tr>
									<th nowrap>Order Call</th>
									<th nowrap>Contacted</th>
									<th nowrap>Verified</th>
									<th nowrap>Agen Online</th>
								</tr>
							</thead>
							<tbody id="num_area">
								<tr>
	...
	<div class='col-md-6 col-xl-6'>
		<div class="card">
			<div class="card-status bg-orange"></div>
			<div class="card-header">
				<h3 class="card-title">Handphone And Email Periode <?php echo $_GET['start'] . " sd " . $_GET['end'] ?>
				</h3>
				<div class="card-options">
					<a href="#" class="card-options-collapse " data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
					<a href="#" class="card-options-fullscreen " data-toggle="card-fullscreen"><i class="fe fe-maximize"></i></a>
				...
				<div class='box-body table-responsive' id='box-table'>
					<small>
						<table class='table'>
							...
							<tbody id="num_hp_email_area">
								<tr>
									<td id="hp_email">-</td>
									<td id="hp_only">-</td>
									<td id="total_hp_email">-</td>
								</tr>
							</tbody>
						</table>
					</small>
	...
	<script type="text/javascript">
		...
		function update_base_list_area() {
			...
			var agentid = $("#agentid").val();
			$.ajax({
				url: "<?php echo base_url() . "Report_profiling/Report_profiling/get_data_list" ?>",
				data: {
					start: start,
					end: end,
					agentid: agentid
