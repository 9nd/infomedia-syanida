   ...
   function __construct(){
	...
	public function create_action(){
		...
		*/	
		...
		//mencegah data kosong
		if(!$o->not_empty($val['tempat_lahir'],'#tempat_lahir')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['tanggal_lahir'],'#tanggal_lahir')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['tanggal_gabung'],'#tanggal_gabung')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['jenis_kelamin'],'#jenis_kelamin')){
			echo $o->result();	
			return;
		}
		...
		//mencegah data kosong
		if(!$o->not_empty($val['status_perkawinan'],'#status_perkawinan')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['kelurahan'],'#kelurahan')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['kecamatan'],'#kecamatan')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['kabupaten_kota'],'#kabupaten_kota')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['provinsi'],'#provinsi')){
			echo $o->result();	
			return;
		}
		...
		//mencegah data double
		$field=array('no_hp'=>$val['no_hp']);
		$exist = $this->tmodel->if_exist('',$field);
		if(!$o->not_exist($exist,'#no_hp')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['no_hp_lain'],'#no_hp_lain')){
			echo $o->result();	
			return;
		}

		//mencegah data double
		$field=array('no_hp_lain'=>$val['no_hp_lain']);
		$exist = $this->tmodel->if_exist('',$field);
		if(!$o->not_exist($exist,'#no_hp_lain')){
			echo $o->result();	
			return;
		}
		...
		//mencegah data double
		$field=array('no_ktp'=>$val['no_ktp']);
		$exist = $this->tmodel->if_exist('',$field);
		if(!$o->not_exist($exist,'#no_ktp')){
			echo $o->result();	
			return;
		}
		...
		//mencegah data kosong
		if(!$o->not_empty($val['jurusan'],'#jurusan')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['sekolah'],'#sekolah')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['tahun_lulus'],'#tahun_lulus')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['no_rekening'],'#no_rekening')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['nama_bank'],'#nama_bank')){
			echo $o->result();	
			return;
		}

		//mencegah data kosong
		if(!$o->not_empty($val['npwp'],'#npwp')){
			echo $o->result();	
			return;
		}
