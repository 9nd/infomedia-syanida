        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card">
                <div class="card-body p-3 text-center">
                    ...
                    <div class="h1 m-0" id="avaliable">-</div>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card">
                <div class="card-body p-3 text-center">
                    ...
                    <div class="h1 m-0" id="oncall">-</div>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card">
                <div class="card-body p-3 text-center">
                    <?php
                    if ($cache['aht'] != 0) {
                        if ($cache_monev_realtime['aht'] < $aht) {
                    ?>
                            <div class="text-right text-green">
                                <?php
                                echo abs($cache['aht']);
                    ...
                    ?>
                    <div class="h1 m-0"><?php echo $aht; ?></div>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card">
                <div class="card-body p-3 text-center">
                    <?php
                    if ($cache['wfh_num'] != 0) {
                        if ($cache_monev_realtime['wfh_num'] < $wfh_num) {
                    ?>
                            <div class="text-right text-green">
                                <?php
                                echo abs($cache['wfh_num']);
                                echo '<i class="fe fe-chevron-up"></i>';
                                ?>
                            </div>
                        <?php
                    ...
                    ?>
                    <div class="h1 m-0"><?php echo $wfh_num; ?></div>
                    <div class="text-muted mb-4">WFH</div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function get_oncall() {
        $.ajax({
            url: "<?php echo base_url() . "Monev/Monev/get_oncall/" . $duty_num; ?>",
            methode: "get",
            dataType: 'JSON',
            success: function(response) {
