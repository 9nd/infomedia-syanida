            ...
            <td colspan="2" width="70%">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <?php
                        $tgllahir = $controller->db->query("SELECT * FROM sys_user_detail WHERE agentid='$userdata->agentid'")->row();
                        $curentdate = date('m-d');

                        if ($curentdate == substr($tgllahir->tanggal_lahir, 5, 5)) {

                        ?>
                            <marquee direction="left" width="500" height="100">
                                <div class="col-md">
                                    <a href="<?php echo base_url() . "Birthday/Birthday/"; ?>" class="card p-3 btn btn-primary btn-card">
                                        <div class="d-flex align-items-center">
                                            <span class="stamp stamp-md bg-primary mr-3">
                                                <i class="fa fa-birthday-cake"></i>
                                            </span>
                                            <div class="text-left">
                                                <p class="m-0 text-primary"> Selamat Ulang tahun <?php echo $userdata->nama ?></p>
                                                <small class="text-muted">Klik tombol ini ya :)</small>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        ?>
                                                ...
                                                <div class="col-sm-6">
                                                    <a href="<?php echo base_url() . "dashboard_v2/wallboard_indibox"; ?>" class="card p-3 btn btn-danger btn-card">
                                                        <div class="d-flex align-items-center">
                                                            <span class="stamp stamp-md bg-red mr-3">
                                                                <i class="fe fe-tag"></i>
                                                            ...
                                                            <div class="text-left">
                                                                <p class="m-0 text-red">WALLBOARD INDIBOX DAILY</p>
                                                                <small class="text-muted">Indibox Wallboard Daily</small>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                                        ...
                                        ?>
                                            <div class="col-sm-6">
                                                <a href="<?php echo base_url() . "Moss_tvv/Moss_tvv"; ?>" class="card p-3 btn btn-primary btn-card">
                                                    <div class="d-flex align-items-center">
                                                        <span class="stamp stamp-md bg-blue mr-3">
                                                            <i class="fe fe-users"></i>
                                                        ...
                                                        <div class="text-left">
                                                            <p class="m-0 text-blue">Input Data</p>
                                            ...
                                            <div class="col-sm-6">
                                                <a href="<?php echo base_url() . "Histori_call_tvv/Histori_call_tvv"; ?>" class="card p-3 btn btn-success btn-card">
                                                    <div class="d-flex align-items-center">
                                                        <span class="stamp stamp-md bg-green mr-3">
                                                            <i class="fe fe-bar-chart"></i>
                                                        </span>
                                                        <div class="text-left">
                                                            <p class="m-0 text-green">History</p>
                                                            <small class="text-muted">History By Date</small>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
...
<div class="col-sm-6">
                                            <a href="http://10.60.165.60/index.php?idx=0" target="_blank" class="card p-3 btn btn-primary btn-card">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="text-left">
                                                        <p class="m-0 text-blue">e-Payment</p>
                                                        <small class="text-muted">cek biilling pelanggan</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="https://mycx.telkom.co.id/login/" target="_blank" class="card p-3 btn btn-danger btn-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="stamp stamp-md bg-red mr-3">
                                                        <i class="fe fe-link"></i>
                                                    </span>
                                                    <div class="text-left">
                                                        <p class="m-0 text-red">MyCX</p>
                                                        <small class="text-muted">cek info pelanggan</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="https://mykiss.infomedia.co.id/index.php?option=com_users&view=login&lang=en" target="_blank" class="card p-3 btn btn-info btn-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="stamp stamp-md bg-orange mr-3">
                                                        <i class="fe fe-link"></i>
                                                    </span>
                                                    <div class="text-left">
                                                        <p class="m-0 text-orange">MyKiss</p>
                                                        <small class="text-muted">produk knowledge</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="https://ott.upoint.co.id/login" target="_blank" class="card p-3 btn btn-warning  btn-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="stamp stamp-md bg-yellow mr-3">
                                                        <i class="fe fe-link"></i>
                                                    </span>
                                                    <div class="text-left">
                                                        <p class="m-0 text-yellow">Ott UPOINT</p>
                                                        <small class="text-muted">aktifasi catchplay</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="http://10.60.166.219/mosstools/" target="_blank" class="card p-3 btn btn-danger btn-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="stamp stamp-md bg-red mr-3">
                                                        <i class="fe fe-link"></i>
                                                    </span>
                                                    <div class="text-left">
                                                        <p class="m-0 text-red">MOSS TOOLS</p>
                                                        <small class="text-muted">aktifasi minipack</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="https://subsystem.indihome.co.id/dashboard-ultra/login" target="_blank" class="card p-3 btn btn-primary btn-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="stamp stamp-md bg-blue mr-3">
                                                        <i class="fe fe-link"></i>
                                                    </span>
                                                    <div class="text-left">
                                                        <p class="m-0 text-blue">Dashboard Ultra</p>
                                                        <small class="text-muted">aktifasi Landing Page</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="https://subsystem.indihome.co.id/dashboard-leads/profiling" target="_blank" class="card p-3 btn btn-primary btn-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="stamp stamp-md bg-blue mr-3">
                                                        <i class="fe fe-link"></i>
                                                    </span>
                                                    <div class="text-left">
                                                        <p class="m-0 text-blue">Dashboard Leads</p>
                                                        <small class="text-muted">aktifasi Landing Page</small>
                                                    </div>
                                                </div>
                                            </a>
                        ...
                        ?>
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title">5 Temuan qc terakhir</h3>

                                    </div>
                                    <div class="card-body">
                                        <?php
                                        $temuan =  $this->db->query("SELECT * FROM qc WHERE status_approve = '0' AND (agentid = '$userdata->agentid' or agentid = '$userdata->agentid_mos') ORDER BY tanggal DESC limit 5 ");
                                        $no = 1;
                                        foreach ($temuan->result() as $datanya) {

                                        ?>


                                            <div class="col-md">
                                                <a href="<?php echo base_url() . "Banding/Banding/lihat_temuan/?id=" . $datanya->id; ?>" class="card p-3 btn btn-danger btn-card">
                                                    <div class="d-flex align-items-center">
                                                        <span class="stamp stamp-md bg-red mr-3">
                                                            <?php echo $no;
                                                            $no++; ?>
                                                        ...
                                                        <div class="text-left">
                                                            <p class="m-0 text-red"><?php echo $datanya->lup ?></p>
                                                            <small class="text-muted"><?php echo $datanya->reason_qa ?></small>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
