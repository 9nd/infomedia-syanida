...
<head>
	...
	<title id="title_app"><?php echo $this->_appinfo['template_title_bar'] ?></title>
...
<?php
$o		= new Outputview();
$jumlah_pesan =  $o->get_jumlah_pesan();
?>
					...
					<div class="d-flex">
						...
						<div class="d-flex order-lg-2 ml-auto">
							<div class="dropdown d-none d-md-flex">
								<a href="<?php echo base_url() . "Inbox/Inbox" ?>" class="nav-link icon <?php echo ($jumlah_pesan > 0 ? 'icon-shake-jump' : '') ?>">
									<i class="fe fe-mail text-blue"> </i>
									<?php echo ($jumlah_pesan > 0 ? "<span class='nav-unread-message' id='inbox_count'>$jumlah_pesan</span>" : '') ?>
...
<!-- 
	...
	<section id="section_script">
		...
		<script id="src_ybs" src="<?php echo base_url() ?>assets/ybs.min.js"></script>
