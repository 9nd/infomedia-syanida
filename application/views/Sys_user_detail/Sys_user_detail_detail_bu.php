...
<form id='form-a'>
	...
	<div class="panel panel-lte">
		...
		<div class="row">
					...
					<table class='display responsive nowrap' id="example" style="width: 100%;">
						<thead>
							<tr>
								...
								<th><b>Level</b></th>
								<th><b>Akomodasi</b></th>
								<th><b>Tunj. Transport</b></th>
								<th><b>Komisi</b></th>
								<th><b>Tunj. Level</b></th>
								<th><b>THP Leveling</b></th>
								<th><b>Perbantuan</b></th>
								<th><b>Total THP</b></th>
								<th><b>&nbsp;</b></th>
							</tr>
						</thead>
						<tbody>
							<?php
							$no = 1;
							$datapayrol = $this->db->query("SELECT * FROM t_payroll WHERE agentid='$data->agentid'");
							foreach ($datapayrol->result() as $datanya) {


							?>
								<tr>
									<td><?php echo $datanya->bulan; ?></td>
									<td><?php echo $datanya->score; ?></td>
									<td><?php echo $datanya->level; ?></td>
									<td><?php echo $datanya->akomodasi; ?></td>
									<td><?php echo $datanya->tunj_transport; ?></td>
									<td><?php echo $datanya->komisi; ?></td>
									<td><?php echo $datanya->tunj_level; ?></td>
									<td><?php echo $datanya->thp_leveling; ?></td>
									<td><?php echo $datanya->nominal_perbantuan; ?></td>
									<td><?php echo $datanya->total_thp; ?></td>

									<td>
										<a href="<?php echo base_url() . "Sys_user_detail/Sys_user_detail/viewpayroll?id=" . $datanya->id  ?>" class="btn btn-default text-red btn-sm" title="lihat"><i class="fa fa-eye"></i></a>
										<!-- <a href="<?php echo base_url() . "Sys_user_detail/Sys_user_detail/download?id=" . $datanya->id  ?>" class="btn btn-default text-red btn-sm" title="lihat"><i class="fa fa-download"></i></a> -->
									</td>
								</tr>
							<?php
								$no++;
			...
			<br>
			<div class="col-md">
				<canvas id="barChartpayroll" style="height:230px; min-height:230px"></canvas>
			</div>
