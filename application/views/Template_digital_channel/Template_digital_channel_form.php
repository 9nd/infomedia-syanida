...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->template_digital_channel_template ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='template' name='template' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->template ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->template_digital_channel_jumlah_konten ?></label>
							<input type='text' class='form-control data-sending focus-color ybs-input-number' id='jumlah_konten' name='jumlah_konten' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo number_format($data->jumlah_konten,2) ?>' autocomplete='off'>
					</div>
					</div>
			
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->template_digital_channel_kode_template ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='kode_template' name='kode_template' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->kode_template ?>' >
					</div>
					</div>
