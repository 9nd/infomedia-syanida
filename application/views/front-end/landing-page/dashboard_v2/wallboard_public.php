...
<body style="background-color:#202938;color:#efeef0; font-family:Arial, Helvetica, sans-serif;">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<div class="row">
				<div class="col-md-4">
						...
						<input type="date" class='form-control' name="start" id="start" value="<?php echo $start; ?>">
				
				</div>
				<div class="col-md-4">
					
						<input class='form-control' type="date" name="end" id="end" value="<?php echo $end; ?>">
				
				</div>
				<div class="col-md-2">
					
						<button type="submit" id="filter" class='form-control'><i class="fa fa-search"></i></button>
		...
		<div class="col-md-4">
			<img src="<?php echo base_url('api/Public_Access/get_logo_login') ?>" class="fontlogo" alt="" width="100%">

		</div>
	</div>
	<table width="100%">
		<tr>
			<td style="color:#a3a8ac;font-size:25px;text-align:center;" width="25%"><i class="fa fa-cog"></i> WORK ORDER</td>
		...
		<tr>
			<td style="color:#fff;font-size:100px;text-align:center;" valign='top' id="callorder_reguler">-</td>
	...
	<script type="text/javascript">
		function get_performance() {
			...
			$("#daily_status").val(0);
			$.ajax({
				url: "<?php echo base_url() . "api/Dashboard_v2/get_daily_performance_reg" ?>",
				methode: "get",
				data: {
					start: start,
					end: end
