...
<form id='form-a'>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->sys_user_moss_agentid ?></label>
			<?php $v = '';
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->sys_user_moss_periode_start ?></label>
			<div class='input-group'>
				<span class='input-group-prepend' id='basic-addon1'>
					<span class='input-group-text'><i class="fa fa-calendar"></i></span>
				</span>
				<input readonly type='text' class='form-control data-sending input-simple-date' placeholder='<?php echo $title->general->desc_required ?>' id='periode_start' value='<?php if (isset($data)) echo $data->periode_start ?>'>
			</div>
		</div>
	</div>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->sys_user_moss_periode_end ?></label>
			<div class='input-group'>
				<span class='input-group-prepend' id='basic-addon1'>
					<span class='input-group-text'><i class="fa fa-calendar"></i></span>
				</span>
				<input readonly type='text' class='form-control data-sending input-simple-date' placeholder='<?php echo $title->general->desc_required ?>' id='periode_end' value='<?php if (isset($data)) echo $data->periode_end ?>'>
			</div>
		</div>
	</div>
	...
	<div class='col-md-12 col-xl-12'>
		<div class='form-group'>
			<label class='form-label'><?php echo $title->sys_user_moss_shift ?></label>
			<?php $v = '';
			if (isset($data)) $v = $data->shift;
			echo create_cmb_database(array(
				'id'			=> 'shift',
				'name'			=> 'shift',
				'table'			=> 'shift_moss',
				'field_show'	=> 'keterangan',
				'primary_key'	=> 'id',
				'selected'		=> $v,
				'field_link'	=> '',
				'class'			=> 'custom-select data-sending'
