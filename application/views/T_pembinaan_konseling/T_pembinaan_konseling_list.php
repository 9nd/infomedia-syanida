			...
			<table class='display responsive' id="example" style="width: 100%;">
				<thead>
					<tr>
						...
						<th style="font-size: 12px"><b>Nama Konseling</b></th>
						<th style="font-size: 12px"><b>Konselor</b></th>
						<th style="font-size: 12px"><b>Tanggal</b></th>
						<th style="font-size: 12px"><b>Data Performance</b></th>
						<th style="font-size: 12px"><b>Ketidak Sesuaian</b></th>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td style="font-size: 11px"><?php echo $datana->nama_konseling; ?></td>
							<td style="font-size: 11px"><?php echo $datana->konselor; ?></td>
							<td style="font-size: 11px"><?php echo $datana->bulan_tahun; ?></td>
							<td style="font-size: 11px"><?php echo $datana->data_performance; ?></td>
							<td style="font-size: 11px"><?php echo $datana->ketidaksesuaian; ?></td>
							<td style="font-size: 11px"><?php echo $datana->jenis_pembinaan; ?></td>
							<td style="font-size: 11px"><?php echo $datana->komitmen_perbaikan; ?></td>
