...
<div class='col-md-12 col-xl-12'>
	<div class="card">
		...
		<div class="card-header">
			...
			<h3 class="card-title">Rekap Pembinaan
			</h3>
					...
					<div class="row">
						...
						<div class='col-md border-left'>
							<div class='form-group'>
								<table width="100%">
									<tr>
										<td width="50%">
											...
											start <input type='date' class='data-sending focus-color' id='start' name='start' value='<?php if (isset($_GET['start'])) echo $_GET['start'] ?>'>
											End <input type='date' class='data-sending focus-color' id='end' name='end' value='<?php if (isset($_GET['end'])) echo $_GET['end'] ?>'>

										</td>
										<td>
										<label class='form-label'>Agent</label>

											<select name='agentid' id="agentid" class="form-control custom-select data-sending" multiple='multiple'>
								...
								<button id='btn-save' type='submit' class='btn btn-primary'><i class="fe fe-save"></i>
									Show Data</button>
							</div>
						</div>
					</div>
...
?>
	...
	<script type="text/javascript">
		...
		function update_base_list_area() {
			...
			var end = $("#end").val();
			$.ajax({
				url: "<?php echo base_url() . "T_pembinaan/T_pembinaan/get_data_list" ?>",
				data: {
					start: start,
					end: end
				},
