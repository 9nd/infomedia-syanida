...
?>
	...
	<script type="text/javascript">
		...
		function update_base_num_area() {
			...
			$.ajax({
				url: "<?php echo base_url() . "Qm_score/Qm_score/get_data_num_live_query" ?>",
				data: {
					start: start,
					end: end,
					periode: periode,
		...
		function update_base_list_area() {
			...
			var end = $("#end").val();
			$.ajax({
				url: "<?php echo base_url() . "Qm_score/Qm_score/get_data_list_report" ?>",
				data: {
					start: start,
					end: end,
				},
		...
		function update_base_num_hp_email_area() {
			...
			var agentid = $("#agentid").val();
			$.ajax({
				url: "<?php echo base_url() . "Qm_score/Qm_score/get_list_hp_email" ?>",
				data: {
					start: start,
					end: end,
					periode: periode,
