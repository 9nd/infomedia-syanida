...
<form id='form-a'>
	...
	<input disabled hidden type='text' class='form-control data-sending focus-color' id='sumber' name='sumber' value='TVV'>
	<input disabled hidden type='text' class='form-control data-sending focus-color' id='layanan' name='layanan' value='TVV'>
