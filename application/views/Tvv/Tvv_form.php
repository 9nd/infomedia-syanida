...
<form id='form-a'>
	...
	<input hidden type='text' class='form-control data-sending focus-color' id='sumber' name='sumber' value='TVV'>
	<input hidden type='text' class='form-control data-sending focus-color' id='layanan' name='layanan' value='TVV'>
