...
<div class="card ">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo base_url() ?>Outbound/Outbound/insertdata?phone=<?php echo $_GET['phone']; ?>&ncli=<?php echo  $_GET['ncli']; ?>&userid=<?php echo  $_GET['userid']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary" href="javascript:void(0)" onclick="copypaste()">Copy</a>
...
<script>
    $(document).ready(function() {
        ...
        $('#startcount').stopwatch().click(function() {
            var no_handphone = $('#no_handpone').val();;
            var agentid = "<?php echo $_GET['userid']; ?>";
            var ncli = "<?php echo $_GET['ncli']; ?>";
            ...
            if (no_handphone === '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>Outbound/Outbound/handletime",
                    data: {
                        agentid: agentid,
                        ncli: ncli,
