...
<?php
                                        if (in_array($datana['no_handpone'], $blacklist)) {
                                        ?>
                                            <a target="_blank" href="<?php echo base_url() ?>Outbound/Outbound/edit?idx=<?php echo $datana['idx'] ?>&phone=<?php echo $datana['no_pstn']; ?>&ncli=<?php echo $datana['ncli']; ?>&hp=<?php echo $datana['no_handpone']; ?>"><span class="btn btn-sm btn-primary">Submit RNA</span></a>
                                        <?php
                                        } else {
                                        ?>
