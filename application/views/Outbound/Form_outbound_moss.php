...
<div class="card ">
    ...
    <div class="card-header">
        ...
        <div class="card-options">
            ...
            <a href="javascript:void(0)" onclick="copypaste()">
            ...
            ?>
                <div class="btn-sm btn-success" id="startcount">
                    <i class="fa fa-phone"></i> Start Handling
                </div>
                &nbsp; &nbsp;
            <?php
            }
            ...
            <div class="btn-sm btn-danger" id="closet">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo base_url() ?>Outbound/Outbound/insert_moss" method="post" enctype="multipart/form-data">
            ...
            <input hidden id="click_time" name="click_time" value="<?php
                                                                    $click_time = '0000-00-00 00:00:00';
            ...
            <div class="panel panel-lte">
                ...
                <div class="panel-body row">
                    <div class="col-md-6" style="font-size: 16px;">
                        ...
                        <br>
                        bapak/ibu mohon maaf sekali aktivasi nya belum bisa kami lanjutkan, untuk pengaktifan harus terhubung langsung dengan pemilik fastel, bila bapak/ ibu tidak keberatan silakan inputkan no hp bapak/ibu  (nama fastel)
                        <br><br>
                        <b>edukasi ke plaza jika pelanggan pemilik baru</b>
                        <br>
                        ...
                        <br>
                        Yang bertanggung jawab untuk pembayaran tagihan produk telkomnya, dengan bapak/ ibu sendiri?</b>
                        <br><br>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <table widht="100%">
                                        <tr>
                                            <td width="100%"><input type="text" class="form-control data-sending" id="no_speedy" name="no_speedy" value="<?php if (isset($datanya)) echo $datanya->no_speedy; ?>">
                                            </td>
                    ...
                    <div class="col-md border-left">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control data-sending" id="handphone_lainnya" name="handphone_lainnya">
                                <input type="checkbox" class="handphone_lainnya_wa" id="handphone_lainnya_wa" value=1 name="handphone_lainnya_wa">WA</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                            ...
                            <tr>
                                <td colspan=2 align="right">
                                    <div class="btn btn-warning" id="add2"><span class="fe fe-plus-circle"></span>
                                        <div>
                                </td>
                            </tr>
                    ...
                    <div class="col-md border-left">
                        <div class="panel panel-lte">
                            ...
                            <table width="100%">
                                <tr>
                                    <td>Nama</td>
                                    <td width="10px"><input type="checkbox" class="data-sending validate"  name="checked_nama"></td>
                                ...
                                <tr>
                                    <td>Alamat</td>
                                    <td width="10px"><input type="checkbox" class="data-sending validate"  name="checked_alamat"></td>
                                ...
                                <tr>
                                    <td>Kecepatan</td>
                                    <td width="10px"><input type="checkbox" class="data-sending validate"  name="checked_kecepatan"></td>
                                    <td>
                                ...
                                <tr>
                                    <td>Tagihan</td>
                                    <td width="10px"><input type="checkbox" class="data-sending validate"  name="checked_tagihan"></td>
                                    <td>
                                ...
                                ?>
                                    <tr>
                                        <td>Tempat Bayar</td>
                                        <td width="10px"><input type="checkbox" class="data-sending validate"  name="checked_tempatbayar"></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10px"><input type="checkbox" class="data-sending validate"  name="checked_tahnpemasangan"></td>
                                        <td>
            ...
            <div class="panel panel-lte">
                ...
                <div class="panel-body row">
                    <div class="col-md-6" style="font-size: 16px;">
                        ...
                        Baik bapak/ibu  verifikasi sudah selesai.
                        <br>
                        Perihal informasinya sudah cukup jelas ya Bapak/Ibu?
                        <br>
                        Ada lagi yang bisa kami bantu, pak/bu?
                        <br><br>
...
?>
    <div class="btn btn-success pull-left" style="position: sticky; bottom:0;
    left:0;">
        Today Verified: <?php echo $verifagnt->jml; ?>
    </div>
<?php
}
?>
        ...
        $('form').submit(function() {
            ...
            if (relasi === '' && veri_status == '1') {
                ...
                ?>
                    // $.ajax({
                    //     type: "POST",
                    //     url: "<?php echo base_url() ?>Outbound/Outbound/handletimeu",
                    //     data: {
                    //         agentid: agentid
                    //     },
                    //     // data: "agentid=" + agentid +  "no_handphone=" + no_handphone ,
