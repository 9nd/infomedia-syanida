                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input pattern="[0-9]" type="number" class="form-control data-sending" id="billing" name="billing" value="<?php if (isset($datanya)) echo str_replace(array('.', ',00'), '', $datanya->tagihan); ?>"></td>
