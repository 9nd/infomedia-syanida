        ...
        <div class="container-fluid site-width">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    ?>
                        <form method="POST" action="<?php echo base_url()."Report/Report/kpi"?>">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="border-0 outline-badge-success w-50 p-3 rounded text-center"><span class="h5 mb-0"><?php echo number_format(($achievement_target * 100), 2); ?>%</span><br />
                                            Achievement Target
                            ...
                            <tbody>
                                ...
                                if (count($agent) > 0) {
                                    ...
                                    foreach ($agent as $kode_tl => $datana) {
                                        ...
                                        echo "<td style='text-align:center;'>" . number_format(($agent[$kode_tl][13]) / (22*12)) . "</td>";
                                        echo "<td style='text-align:center;'>" . number_format(($agent[$kode_tl]['oc']) / (22*12)) . "</td>";
                                        echo "</tr>";
                                    }
                                }
                                ?>
                        ...
                        <table class="table">
                            ...
                            if (count($tl) > 0) {
                                ...
                                foreach ($tl as $kode_tl => $datana) {
                                    ...
                                    echo "<td>" . number_format(($tl[$kode_tl][13] / count($tl[$kode_tl]['underteam'])) / (22*12)) . "</td>";
                                    echo "<td>" . number_format(($tl[$kode_tl]['oc'] / count($tl[$kode_tl]['underteam'])) / (22*12)) . "/H</td>";
                                    echo "</tr>";
                                }
                            }
                            ?>
