...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->qm_score_parameter_urutan ?></label>
							<input type='text' class='form-control data-sending focus-color ybs-input-number' id='urutan' name='urutan' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo number_format($data->urutan,2) ?>' autocomplete='off'>
					</div>
					</div>
			
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->qm_score_parameter_keterangan ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->qm_score_parameter_bobot ?></label>
							<input type='text' class='form-control data-sending focus-color ybs-input-number' id='bobot' name='bobot' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo number_format($data->bobot,2) ?>' autocomplete='off'>
					</div>
					</div>
