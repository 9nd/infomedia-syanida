...
<div class='col-md-12 col-xl-12'>
	<div class="card">
		...
		<div class="card-header">
			<h3 class="card-title">Pick date range Report QC Period
			</h3>
...
if (isset($_GET['start']) && isset($_GET['end'])) {
	...
	<div class='col-md-6 col-xl-7'>
		<div class="card">
			...
			<div class="card-header">
				<h3 class="card-title">Summary QC Agent <?php echo $_GET['start'] . " sd " . $_GET['end'] ?>
				</h3>
				<div class="card-options">
					<a href="#" class="card-options-collapse " data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
					<a href="#" class="card-options-fullscreen " data-toggle="card-fullscreen"><i class="fe fe-maximize"></i></a>
	...
	<script type="text/javascript">
		...
		function update_base_list_area() {
			...
			var agentid = $("#agentid").val();
			$.ajax({
				url: "<?php echo base_url() . "Report_qc/Report_qc/get_data_list" ?>",
				data: {
					start: start,
					end: end,
					agentid: agentid
