...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_tahun ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='tahun' name='tahun' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->tahun ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_bulan ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_last_update ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_best_agent ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_best_teamleader ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_verified_best_agent ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_verified_best_teamleader ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_best_agent_moss ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_slg_best_agent_moss ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_best_teamleader_moss ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_slg_best_teamleader_moss ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_verified ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_co ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_contacted ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_not_contacted ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_hp_email ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_hp_only ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_1 ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_1_num ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_2 ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_2_num ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_3 ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_3_num ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_4 ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_4_num ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_5 ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_5_num ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_6 ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_6_num ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_agent_online ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_slg ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='slg' name='slg' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->slg ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->monthly_report_monthly_moss_slfc ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='slfc' name='slfc' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->slfc ?>' >
					</div>
					</div>
