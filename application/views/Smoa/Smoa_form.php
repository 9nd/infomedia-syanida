...
<form id='form-a'>
	<input hidden class='data-sending' id='id_forcall' value='<?php if ($id_forcall != false) echo $id_forcall; ?>'>
	<input hidden type='text' class='form-control data-sending focus-color' id='sumber' name='sumber' value='smoa'>
	<input hidden type='text' class='form-control data-sending focus-color' id='layanan' name='layanan' value='smoa'>
	...
	<input hidden type='text' class='form-control data-sending focus-color' id='click_time' name='click_time' value='<?php echo date('Y-m-d H:i:s'); ?>'>

	<div class="row">
		<div class="col-4">
			<div class='col-md-12 col-xl-12'>
				<div class='form-group'>
					<label class='form-label'>Waktu & Tanggal Data Masuk</label>
					<input type='datetime-local' class='form-control data-sending focus-color' id='tgl_insert' name='tgl_insert' value='<?php if (isset($data)) echo $data->tgl_insert ?>'>
				</div>
			</div>
			...
			<div class='col-md-12 col-xl-12'>
				<div class='form-group'>
					...
					<select name="reason_call" id="reason_call" class="form-control data-sending focus-color">
						...
						<option value="16">Invalid Number</option>
		...
		<div class="col-md">
			<div class='col-md-12 col-xl-12'>
				<div class='form-group'>
					...
					<select class='form-control data-sending focus-color' name="paketsmoa" id="paketsmoa">
			...
			<div class='col-md-12 col-xl-12'>
				<div class='form-group'>
					...
					<table width="100%">
						<tr>
							<td>Parent</td>
							<td> <input type='text' class='form-control data-sending focus-color' id='parent' name='parent' placeholder='' value='<?php if (isset($data)) echo $data->parent ?>'>
							</td>
						</tr>
						<tr>
							<td>Member1</td>
							<td><input type='text' class='form-control data-sending focus-color' id='member1' name='member1' placeholder='' value='<?php if (isset($data)) echo $data->member1 ?>'>
							</td>
						</tr>
						<tr>
							<td>Member2</td>
							<td><input type='text' class='form-control data-sending focus-color' id='member2' name='member2' placeholder='' value='<?php if (isset($data)) echo $data->member2 ?>'>
							</td>
						</tr>
						<tr>
							<td>Member3</td>
							<td><input type='text' class='form-control data-sending focus-color' id='member3' name='member3' placeholder='' value='<?php if (isset($data)) echo $data->member3 ?>'>
							</td>
						</tr>
						<tr>
							<td>Member4</td>
							<td><input type='text' class='form-control data-sending focus-color' id='member4' name='member4' placeholder='' value='<?php if (isset($data)) echo $data->member4 ?>'>
							</td>
						</tr>
						<tr>
							<td>Member5</td>

							<td><input type='text' class='form-control data-sending focus-color' id='member5' name='member5' placeholder='' value='<?php if (isset($data)) echo $data->member5 ?>'>
							</td>
						</tr>
