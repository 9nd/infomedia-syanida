...
<form id='form-a'>
	...
	<input disabled hidden type='text' class='form-control data-sending focus-color' id='sumber' name='sumber' value='smoa'>
	<input disabled hidden type='text' class='form-control data-sending focus-color' id='layanan' name='layanan' value='smoa'>
