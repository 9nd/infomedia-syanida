...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/birthday/assets/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/birthday/assets/stylesheet.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/birthday/assets/loading.css">
    <link rel="stylesheet/less" href="<?php echo base_url();?>assets/birthday/assets/cake.less">
    <script src="<?php echo base_url();?>assets/birthday/assets/less.min.js"></script>
    <script src="<?php echo base_url();?>assets/birthday/config.js"></script>
</head>

<body>
<div class="loading"></div>
<audio class="song" controls loop>
    <source src="<?php echo base_url();?>assets/birthday/assets/hbd.mp3"></source>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="<?php echo base_url();?>assets/birthday/assets/banner.png" class="bannar">
        </div>
    </div>
...
<script src="<?php echo base_url();?>assets/birthday/assets/jquery.min.js"></script>
<script src="<?php echo base_url();?>assets/birthday//assets/bootstrap.min.js"></script>
<script src="<?php echo base_url();?>assets/birthday/assets/effect.js"></script>

<script src="<?php echo base_url();?>assets/birthday/custom.js"></script>
