...
<div class='col-md-12 col-xl-12'>
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h3 class="card-title">Audit Fraud Alert
            </h3>
...
?>
    ...
    <?php echo _js("datatables, ybs,selectize,multiselect") ?>
    ...
    <script type="text/javascript">
        ...
        function update_base_list_area() {
            ...
            var end = $("#end").val();
            $.ajax({
                url: "<?php echo base_url() . "T_fraud_alert_check/T_fraud_alert_check/get_data_list" ?>",
                data: {
                    start: start,
                    end: end
                },
