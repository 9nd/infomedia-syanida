...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_fraud_alert_check_no_handphone ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='no_handphone' name='no_handphone' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->no_handphone ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_fraud_alert_check_tanggal_check ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='tanggal_check' name='tanggal_check' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->tanggal_check ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_fraud_alert_check_update_by ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_fraud_alert_check_reason ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='reason' name='reason' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->reason ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_fraud_alert_check_status_approve ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='status_approve' name='status_approve' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->status_approve ?>' >
					</div>
					</div>
