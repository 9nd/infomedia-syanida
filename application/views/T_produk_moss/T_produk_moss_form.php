...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_produk_moss_nama_chanel ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='nama_chanel' name='nama_chanel' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->nama_chanel ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_produk_moss_kode_chanel ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='kode_chanel' name='kode_chanel' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->kode_chanel ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_produk_moss_harga ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='harga' name='harga' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->harga ?>' >
					</div>
					</div>
