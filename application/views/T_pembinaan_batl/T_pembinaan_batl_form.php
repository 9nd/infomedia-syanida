		...
		<form id='form-a'>
			...
			<div class='col-md-12 col-xl-12'>
				<div class='form-group'>
					...
					<input readonly type='text' class='form-control data-sending focus-color' id='pemberi_teguran' name='pemberi_teguran' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if (isset($userdata->agentid)) echo $userdata->agentid ?>'>
				</div>
			</div>
