...
<body id="main-container" class="default horizontal-menu">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-3">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <select class="form-control" name="veri_call" id="veri_call">
                                    <?php
                            ...
                            <div class="form-group col-md-2">
                                <button type="button" id="filter" onclick="get_status();" class="btn btn-primary">Filter</button>
                            </div>
                        </div>
                    </form>
    ...
    <script type="text/javascript">
        ...
        function get_status() {
            ...
            $("#status").html("<center style='height:244px'>-----LOADING DATA-----</center>");
            $.ajax({
                url: "<?php echo base_url() . "Report/Report/get_status_weekly" ?>",
                data: {
