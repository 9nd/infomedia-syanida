<div class="m-3">
    <b>List Table Verified Channel OBC <?php echo $_GET['date'] ?></b>
    <table id="datalist" class="table dataTable table-striped table-bordered display responsive nowrap" width="100%">
        ...
        <tbody>
            <?php
            $no = 1;
            foreach ($tabledata['listdata']->result() as $ktabledata => $vtabledata) {
            ...
            ?>
                <tr style="height: 5px; font-size: 8px;">
                    ...
                    <td><?php echo $tabledata['listdata_status']['status'][$ktabledata][0].",".$tabledata['listdata_status']['status'][$ktabledata][1].",".$tabledata['listdata_status']['status'][$ktabledata][2] ?></td>
                    ...
                    <td><?php echo $vtabledata->email_lain; ?></td>
