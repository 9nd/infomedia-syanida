                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class='p-4 align-self-center' style="color:red;">
                                <h2><?php echo number_format($rec['dup']-$rec['fraudinput_count']); ?></h2>
                        ...
                        <tbody>
                            ...
                            if (count($rec['rec_hp']) > 0) {
                                foreach ($rec['rec_hp'] as $hp => $datana) {
                                    $n++;
                                    $controller = $this->trans_profiling_daily->live_query("SELECT COUNT(*) as jml FROM t_fraud_alert_check WHERE no_handphone='$hp'")->row()->jml;
                                    if($controller > 0 ){
