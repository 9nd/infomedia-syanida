...
class Dapros_indri_model extends CI_Model
{
    protected $tbl;
    protected $limit = 0;
    protected $offset = 10;
    ...
    function __construct()
    {
        ...
        $this->tbl = "v2_forcall_dapros";
        $this->db = $this->load->database('infomedia',TRUE);
    }
    ...
    function get_row($where = array(), $fields = array('*'), $order_by = array(),$groupby=false)
    {
        $data = array();
        //select field
        if (is_array($fields)) {
