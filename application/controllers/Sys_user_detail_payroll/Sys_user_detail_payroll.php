<?php
require APPPATH . '/controllers/Sys_user_detail_payroll/Sys_user_detail_payroll_config.php';

if (!defined('BASEPATH'))
	exit('No direct script access allowed');

class Sys_user_detail_payroll extends CI_Controller
{
	private $log_key, $log_temp, $title;
	function __construct()
	{
		parent::__construct();
		$this->load->model('Sys_user_detail_payroll/Sys_user_detail_payroll_model', 'tmodel');		
		$this->load->model('Custom_model/Sys_user_table_model', 'Sys_user_table_model');
		$this->log_key = 'log_Sys_user_detail_payroll';
		$this->title = new Sys_user_detail_payroll_config();
	}
	...
	public function index()
	{
		$data = array(
			...
			'title'					=> $this->title,
			'link_refresh_table'	=> site_url() . 'Sys_user_detail_payroll/Sys_user_detail_payroll/refresh_table/' . $this->_token,
			'link_create'			=> site_url() . 'Sys_user_detail_payroll/Sys_user_detail_payroll/create',
			'link_update'			=> site_url() . 'Sys_user_detail_payroll/Sys_user_detail_payroll/update',
			'link_delete'			=> site_url() . 'Sys_user_detail_payroll/Sys_user_detail_payroll/delete_multiple',
		);

		$this->template->load('Sys_user_detail_payroll/Sys_user_detail_payroll_list', $data);
	}
	...
	public function create()
	{
		$data = array(
			...
			'title'					=> $this->title,
			'link_save'				=> site_url() . 'Sys_user_detail_payroll/Sys_user_detail_payroll/create_action',
		...
		$this->template->load('Sys_user_detail_payroll/Sys_user_detail_payroll_form', $data);
	}
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'title_page_big'		=> 'Buat Baru',
				'title'					=> $this->title,
				'link_save'				=> site_url() . 'Sys_user_detail_payroll/Sys_user_detail_payroll/update_action',
				'link_back'				=> $this->agent->referrer(),
				'data'					=> $row,
				'id'					=> $id_generate,
			);
