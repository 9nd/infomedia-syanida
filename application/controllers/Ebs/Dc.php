...
class Dc extends CI_Controller
{
  ...
  public function campaign()
  {
    ...
    $logindata = $this->log_login->get_by_id($idlogin);
    $data['userdata'] = $this->Sys_user_table_model->get_row(array("id" => $logindata->id_user));
    $data['campaign'] = $this->campaign->get_results(array("join" => array("landing_page" => "landing_page.id = campaign.landing_page")), array("campaign.*,landing_page.title as title_landing_page"));
    $view = 'Dc/campaign';
