<?php
require APPPATH. '/controllers/Qm_score_parameter/Qm_score_parameter_config.php';

if (!defined('BASEPATH'))
    exit('No direct script access allowed');

class Qm_score_parameter extends CI_Controller {
   private $log_key,$log_temp,$title;
   function __construct(){
        parent::__construct();
		$this->load->model('Qm_score_parameter/Qm_score_parameter_model','tmodel');
		$this->log_key ='log_Qm_score_parameter';
		$this->title = new Qm_score_parameter_config();
   }
	...
	public function index(){
		$data = array(
			...
			'title'					=> $this->title,
			'link_refresh_table'	=> site_url().'Qm_score_parameter/Qm_score_parameter/refresh_table/'.$this->_token,
			'link_create'			=> site_url().'Qm_score_parameter/Qm_score_parameter/create',
			'link_update'			=> site_url().'Qm_score_parameter/Qm_score_parameter/update',
			'link_delete'			=> site_url().'Qm_score_parameter/Qm_score_parameter/delete_multiple',
		);
		
		$this->template->load('Qm_score_parameter/Qm_score_parameter_list',$data);
	}
	...
	public function create(){
		$data = array(
			...
			'title'					=> $this->title,
			'link_save'				=> site_url().'Qm_score_parameter/Qm_score_parameter/create_action',
			'link_back'				=> $this->agent->referrer(),			
		);
		
		$this->template->load('Qm_score_parameter/Qm_score_parameter_form',$data);
		...
		**/
		...
		if($row){
			$data = array(
				'title_page_big'		=> 'Buat Baru',
				'title'					=> $this->title,
				'link_save'				=> site_url().'Qm_score_parameter/Qm_score_parameter/update_action',
				'link_back'				=> $this->agent->referrer(),
				'data'					=> $row,
				'id'					=> $id_generate,
			);
