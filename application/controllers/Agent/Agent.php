...
class Agent extends CI_Controller {
   ...
   function __construct(){
	...
	public function report(){
		...
		$data['agent'] = $this->sys_user->get_results($where_agent, array("id,nama,agentid,picture,tl"));
		$data['controller'] = $this; 
		$this->template->load('Agent/report_monitoring_agent',$data);
	}
	public function report_v2(){
		$idlogin = $this->session->userdata('idlogin');
		$logindata = $this->log_login->get_by_id($idlogin);
		$userdata = $this->Sys_user_table_model->get_row(array("id" => $logindata->id_user));
		$data = array(
		...
		$data['agent'] = $this->sys_user->get_results($where_agent, array("id,nama,agentid,picture"));
		$data['controller'] = $this; 
		$this->template->load('Agent/report_monitoring_agent_v2',$data);
	}
	...
	public function convert_second($init){
